...
async function buildContractCrossSell(userId) {
  ...
  return [
    ...
    '',
    '🧿 Real-time MEV defense for your LP pools.',
    '🧿 Sandwich / JIT / frontrun attack blocking.',
...
async function buildScanCrossSell(userId) {
  ...
  return [
    ...
    '',
    '→ Active MEV defense for DeFi pools',
    '→ Detect sandwiches, JIT liquidity, frontruns',
